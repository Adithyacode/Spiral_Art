...
function my_mousemove(e){ 
        ...
        if (mouseEvent == "mouseDown"){
            ...
            console.log("last posistions of x and y coordinates are equal to:");
            console.log("x = " + last_posistion_of_x + "y = " + last_posistion_of_y);
            ctx.moveTo(last_posistion_of_x, last_posistion_of_y);
            console.log("current posistions of x and y coordinates are equal to:");
            console.log("x = " + current_posistion_of_mouse_x + "y = " + current_posistion_of_mouse_y);  
                ctx.beginPath();
                ctx.strokeStyle = color;
                ctx.lineWidth = 2;
                ctx.arc(current_posistion_of_mouse_x, current_posistion_of_mouse_y, 40, 0, 2*Math.PI);
                ctx.stroke();
    }
